...
export const services = [
  {
    ...
    tag2: 'Bespoke',
    image: getAssetUrl('/images/service_bridal.jpg'),
  ...
  },
  {
    ...
    tag1: 'CELEBRATORY',
    tag2: 'Contemporary',
    image: getAssetUrl('/images/service_wedding.jpg'),
  ...
  },
  {
    ...
    tag1: 'FESTIVE CROWD',
    tag2: 'Group Rate',
    image: getAssetUrl('/images/service_events.jpg'),
  ...
  {
    id: 'traditional-marwari',
    title: 'Traditional Marwari',
    tag1: 'HERITAGE CLASSIC',
    tag2: 'Full Arm',
    image: getAssetUrl('/images/service_marwari.jpg'),
  ...
  },
  {
    ...
    tag1: 'SUBTLE CHARM',
    tag2: 'Speedy',
    image: getAssetUrl('/images/service_party.jpg'),
  ...
  },
  {
    ...
    isFeatured: true,
    description: 'Planning your nuptials in Udaipur, Jaipur, Goa, Dubai, or Europe? Our master artist team travels worldwide with complete organic kit provisions.',
    bullets: [
      'All artist travel & stay coordination',
      'Pre-wedding virtual trials & consultation'
    ],
    btnText: 'REQUEST DESTINATION QUOTE',
